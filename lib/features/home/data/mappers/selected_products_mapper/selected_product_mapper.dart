...
@injectable
class SelectedProductMapper extends EntityMapper<SelectedProductEntity, SelectedProductDM> {
  @override
  SelectedProductDM mapFromEntity(SelectedProductEntity? entity) {
    return SelectedProductDM(
  ...
  @override
  List<SelectedProductDM> mapFromEntityList(List<SelectedProductEntity> entities) {
    return entities.map((entity) => mapFromEntity(entity)).toList();
  }

  @override
  SelectedProductEntity? mapToEntity(SelectedProductDM domainModel) {
