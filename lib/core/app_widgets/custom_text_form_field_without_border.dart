...
class CustomTextFieldWithoutBorder extends StatefulWidget {
  final bool obscure;
  final bool align;
  final bool readOnly;
  final bool enable;
  ...
  @override
  State<CustomTextFieldWithoutBorder> createState() => _CustomTextFieldWithoutBorderState();
}

class _CustomTextFieldWithoutBorderState extends State<CustomTextFieldWithoutBorder> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Container(
          decoration: BoxDecoration(shape: BoxShape.rectangle, borderRadius: BorderRadius.circular(widget.radius.h)),
                ...
                return TextFormField(
                  ...
                  onTap: () {
                    if (_controller.selection ==
                        TextSelection.fromPosition(TextPosition(offset: _controller.text.length - 1))) {
                      setState(() {
